...
# from house_prices_model.processing.features import WeekdayImputer, WeathersitImputer
from house_prices_model.processing.features import Mapper
from house_prices_model.processing.features import OutlierHandler

house_prices_pipe = Pipeline([
    ...
    ######## Handle outliers ########
    ('handle_outliers_size', OutlierHandler(variable = config.model_config.size_var)),
    ('handle_outliers_age', OutlierHandler(variable = config.model_config.age_var)),
    ('handle_outliers_distance', OutlierHandler(variable = config.model_config.distance_var)),
